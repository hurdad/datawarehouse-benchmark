...
LOCATION '/user/alex/ssb200/customer/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb200/part/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb200/supplier/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb200/date/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb200/lineorder/';