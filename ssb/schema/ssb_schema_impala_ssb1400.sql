...
LOCATION '/user/alex/ssb1400/customer/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb1400/part/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb1400/supplier/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb1400/date/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb1400/lineorder/';
    C_MktSegment String
)
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/user/alex/ssb1400/customer/';
